  ...
  const GYM_EXERCISES = {
    ...
    'Upper C': [
      ...
      { id:'uc-dbpress', name:'Neutral DB shoulder press',       sets:3, repRange:[8,10],  weight:13,    inc:2,    type:'weighted', cue:'Ribs down, no low-back arch', caution:'No heavy OHP yet, shoulder flags present' },
  ...
  const EX_HOW_TO_TEXTS = (function() {
    ...
    const CALF_DATA = _h(SVG_CALF,
      ['Stand near a wall for balance. Transfer all weight to the left foot. Raise the right foot slightly off the floor.',
       ...
       'Left leg only at all times until the right foot is cleared.',
